...
QtObject {
    ...
    readonly property string _configDir: Quickshell.env("HOME") + "/.config/Ghost"
    readonly property string _luaPath:  _configDir + "/GhostKeybinds.lua"
    readonly property string _confPath: _configDir + "/GhostKeybinds.conf"
    ...
    function _genLua() {
        ...
        var lines = [
            ...
            "",
            "-- ==============================================================================",
            "-- Ghost Capture Submap (Disables all normal binds during recording)",
            "-- ==============================================================================",
            "hl.define_submap(\"Ghost_clean\", function()",
            "    -- Emergency exit in case the shell crashes during capture",
            "    hl.bind(\"CTRL + ESCAPE\", function()",
            "        hl.dispatch(hl.dsp.exec_cmd(\"notify-send 'Ghost' 'Emergency Exit: Keybinds re-enabled.'\"))",
    ...
    function _genConf() {
        ...
        var lines = [
            ...
            "# ==============================================================================",
            "submap = Ghost_clean",
            "bind = CTRL, ESCAPE, exec, notify-send 'Ghost' 'Emergency Exit: Keybinds re-enabled.'",
