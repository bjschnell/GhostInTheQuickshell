...
QtObject {
	...
	readonly property string configPath: Quickshell.env("HOME") + "/.config/Ghost/src/user_data/wallpaper.json"
    ...
    property var readConfigProc: Process {
        ...
        onExited: function() {
            ...
            if (root.currentWall === "") {
                var defaultWall = Quickshell.shellDir + "/src/assets/wallpapers/ghost-default-0.png"
