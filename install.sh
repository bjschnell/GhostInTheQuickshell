...
BACKUP_DIR="$HOME/.config.backup-${BACKUP_TS}-Ghost"
mkdir -p "$BACKUP_DIR"
...
echo ""
log_ok "Ghost is installed."
echo ""
echo -e "  ${BOLD}Restart Hyprland to activate Ghost:${NC}"
